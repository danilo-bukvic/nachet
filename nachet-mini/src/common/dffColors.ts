...
// Each discovered concept (a shared sub-part across a species' seeds) gets one
// distinct, stable hue by index.
...
/** RGB color for a concept index (wraps around the hue list). */
